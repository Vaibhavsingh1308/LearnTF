            ...
            <div className='recipes-for-you-section pb-[24px] lg:pb-[48px]'>
                <div className="container">
                    <div className='recipes-for-sec-head flex flex-row items-center justify-between pb-[12px] md:pb-[16px] lg:pb-[32px]'>
                        <h3 className='text-black text-[28px] md:text-[28px] font-extrabold leading-normal common-sec-title'>Scene Tile</h3>
                    </div>

                    <div className="recipes-items-outer grid grid-cols-1 xl:grid-cols-5 gap-[8px] md:gap-[16px] lg:gap-[24px]">
                        <div className='col-span-5 xl:col-span-3 recipes-featured-block scene-featured-dark-card relative bg-black md:pt-[50px] md:px-[53px] lg:px-[60px] lg:pb-[90px] pt-[32px] pb-[42px] px-[36px] rounded-xl overflow-hidden flex items-start justify-between flex-col'>
                            <div className="scene-card-logo-image mb-10">
                            ...
                            <div className='recipes-featured-block-desc pt-[78px] md:pt-[152px] lg:pt-[0]'>
                                <h3 className='text-white text-[32px] md:text-[48px] leading-none uppercase mb-[20px] md:mb-[35px] lg:mb-[32px] font-bold popins'>Ready for fresh <span className='block neodisplay' style={{ fontFamily: 'auto' }}>Rewards?</span></h3>
                                <p className='text-white text-[14px] md:text-[24px] lg:text-[16px] font-normal leading-normal mb-[30px] md:mb-[53px] lg:mb-[48px] popins'>Earn and redeem Scene+ points at Sobeys today.</p>
                                <Link href="#" className="bg-white px-[14px] py-[11px] rounded-[30px] max-w-[140px] h-[40px] flex items-center justify-center text-black">Learn More</Link></div>
                        ...
                        <div className='col-span-5 xl:col-span-2 recipes-featured-cards-row grid gap-[8px] md:gap-[16px] lg:gap-[30px]'>
